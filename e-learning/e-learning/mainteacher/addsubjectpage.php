        ...
        <div class="row">
          ...
          <div class="col-sm">
            <div class="card">
              ...
              <div class="card-body">
                <form action="../script/addsubject.php" method="POST" autocomplete="off">
                  <div class="form-group">
                    <label for="codeId">Subject code</label>
                    <input id="codeId" class="form-control" type="text" name="scode" placeholder="Subject code..." required>
                  </div>
                  <div class="form-group">
                    <label for="nameId">Subject name</label>
                    <input id="nameId" class="form-control" type="text" name="sname" placeholder="Subject name..." required>
                  </div>
                  <div class="form-group">
                    <label for="infoId">Subject description</label>
                    <input id="infoId" class="form-control" type="text" name="sinfo" placeholder="Short description">
                  </div>
                  <div class="form-group">
                    ...
                    <button class="btn btn-danger btn-block">
                      <a href="subjectlist.php" style="text-decoration: none; color: white;">Back</a>
                    </button>
              </div>
            </div>
          </div>

...
<html>
  ...
  <body>
    ...
    <div id="main">
      ...
      <a class="btn btn-success btn-md" href="addlecturepage.php">
      <i class="fas fa-plus"></i> Add New Lecture</a><br><br>
            ...
            <div style="overflow:scroll;">
              <tbody>
                <tr align="center">
                  ...
                  <td>
                    <a class="btn btn-info btn-sm btn-block" href="viewselectedlecture.php?file=<?php echo $row['file']; ?>">View</a>
                    <a class="btn btn-danger btn-sm btn-block" onclick="return confirm('are you sure you want to delete?');" href="../script/deletelecture.php?id=<?php echo $row ['ID']; ?>">Remove</a>
                  </td>
                </tr>
              </tbody>
            </div>

        ...
        <div class="col-sm">
          ...
          <div class="btn-grp">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
              ...
              <a class="dropdown-item" href="#">Lecture list</a>
        ...
        <div class="row">
          ...
          <div class="col-sm">
            <div class="card">
              ...
              <div class="card-body">
                <form action="../script/addlecture.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                  ...
                  <div class="form-group">
                    <label for="chapterId">Chapter number and name</label>
                    <input id="chapterId" class="form-control" type="text" name="chapter" placeholder="Ex. Chapter 1-Basic fundamentals" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group col-8">
                    <label for="inputCity">Lecture file</label>
                  ...
                  <button class="btn btn-danger btn-block">
                    <a href="lecturelist.php" style="text-decoration: none; color: white;">Back</a>
                  </button>
              </div>
            </div>
          </div>
